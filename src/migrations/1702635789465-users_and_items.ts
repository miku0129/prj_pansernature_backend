...
export class UsersAndItems1702635789465 implements MigrationInterface {
  name = 'UsersAndItems1702635789465';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "purchase" ("id" SERIAL NOT NULL, "purchased_date" TIMESTAMP NOT NULL DEFAULT now(), "is_ebook" boolean NOT NULL DEFAULT false, "userId" integer, "itemId" integer, CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "item" ("id" SERIAL NOT NULL, "title" character varying(50) NOT NULL, "detail" character varying(500), "price" integer NOT NULL, "image_url" character varying(100) NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
