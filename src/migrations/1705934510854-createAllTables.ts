...
export class CreateAllTables1705934510854 implements MigrationInterface {
    name = 'CreateAllTables1705934510854'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "item" ("id" SERIAL NOT NULL, "title" character varying(50) NOT NULL, "detail" character varying(500), "price" integer NOT NULL, "image_url" character varying(100), "is_ebook" boolean NOT NULL, "weight" integer NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "purchase" ("id" SERIAL NOT NULL, "purchased_date" TIMESTAMP NOT NULL DEFAULT now(), "delivery_address" character varying(100) NOT NULL, "delivery_postalcode" character varying(20) NOT NULL, "is_valid" boolean NOT NULL DEFAULT true, "userId" integer, "itemId" integer, CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`);
