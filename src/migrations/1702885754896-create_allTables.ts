...
export class CreateAllTables1702885754896 implements MigrationInterface {
  name = 'CreateAllTables1702885754896';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "membership" ("id" SERIAL NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "end_date" date NOT NULL, "is_valid" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "PK_83c1afebef3059472e7c37e8de8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
