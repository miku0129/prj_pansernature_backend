...
export class User1702578802943 implements MigrationInterface {
  name = 'User1702578802943';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "purchase" ("id" SERIAL NOT NULL, "purchased_date" TIMESTAMP NOT NULL DEFAULT now(), "is_ebook" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
